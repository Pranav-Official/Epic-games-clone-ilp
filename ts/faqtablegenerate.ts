document.addEventListener("DOMContentLoaded", function () {
  // Sample data
  var tableData: { product: string; countries: string }[] = [
  ...
  function generateTable(data: { product: string; countries: string }[]) {
    var tableContainer =
      document.getElementById("table-container") ?? document.body;
