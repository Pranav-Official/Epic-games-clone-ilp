...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var tableData = [
        ...
        {
            product: "Paysafecard *",
            countries: "AT, AU, BE, CY, CZ, DE, DK, ES, FI, FR, GE, IE, IT, LT, LU, NL, NO, PL, PT, SE, SI, SK",
        },
    ...
    function generateTable(data) {
        var _a;
        var tableContainer = (_a = document.getElementById("table-container")) !== null && _a !== void 0 ? _a : document.body;
        ...
        data.forEach(function (item) {
            ...
            tdMethod.innerHTML = "<p>" + item.product + "</p>";
